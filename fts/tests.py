...
class MicroTest(LiveServerTestCase):
	...
	def test_can_create_maintenance_via_admin_site(self):
		...
		#She now sees a couple of hyperlink that says "Branch"
		branches_links = self.browser.find_elements_by_link_text('Branch')
		self.assertEquals(len(branches_links), 2)
